...
char *battleUI[] =
{
" _ ______ ______ ______ ______ ______ ______ ______ ______ ______ ______ _ ______ ______ ______ ______ ______ ______ ______ ",
"|_|______|______|______|______|______|______|______|______|______|______|_|______|______|______|______|______|______|______|",
"| |                                                                     | |                                                |",
"| |   %s                   %i                                           | |    Enemy                 Level                 |",
"| |                                                                     | |                                                |",
...
void BattleUI()
{
  ...
  */
  ...
  for (int i = 0; i < _countof(battleUI); i++)
  {
	  ...
	  {
	  case 3:
      strcpy(buff, "| |___________________________| |   %s                   %i                                           | |    Enemy                 Level                 | |", player.name, player.level);
		  printf(" _ ______ ______ ______ ______ ______ ______ ______ ______ ______ ______ _ ______ ______ ______ ______ ______ ______ ______ _ ______ ______ ______ ______ _ ", buff);
		  break;
	  default:
		  printf("%s\n", battleUI[i], player.name);
		  break;
	  }
  }
